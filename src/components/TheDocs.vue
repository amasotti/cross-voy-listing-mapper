...
<template>
  <div class="banner-container">
    ...
    <!--      Now disclaimer for techies-->
      <p class="description">
        <span class="fw-bold">For Nerds:</span> this is a small utility I wrote with TS (Vue3). It is really simple: just parse the input, uses some regex and then uses a mapping from the param names
        in the source language to the target language. The mapping is stored in a JSON file. Nothing special, but feel free to improve it here.
      </p>
    </div>
  </div>
</template>
